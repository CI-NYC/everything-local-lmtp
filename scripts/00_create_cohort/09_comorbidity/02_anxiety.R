...
anxiety_icds <- read_csv("~/disability/projects/create_cohort/input/ICD_codes/anxiety_icd10_20230323.csv", col_names = F) |>
...
all_anxiety_oth <- all_dg_clean |>
  ...
  mutate(min_anxiety_dt_0 = pmax(min_anxiety_dt_0, min_anxiety_dt_0_iph, na.rm = TRUE),
         min_anxiety_dt_1 = pmax(min_anxiety_dt_1, min_anxiety_dt_1_iph, na.rm = TRUE),
         min_anxiety_dt_2 = pmax(min_anxiety_dt_2, min_anxiety_dt_2_iph, na.rm = TRUE),
         min_anxiety_dt_3 = pmax(min_anxiety_dt_3, min_anxiety_dt_3_iph, na.rm = TRUE),
         min_anxiety_dt_4 = pmax(min_anxiety_dt_4, min_anxiety_dt_4_iph, na.rm = TRUE),
         min_anxiety_dt_5 = pmax(min_anxiety_dt_5, min_anxiety_dt_5_iph, na.rm = TRUE),
         min_anxiety_dt_6 = pmax(min_anxiety_dt_6, min_anxiety_dt_6_iph, na.rm = TRUE)
  ) |>
  select(BENE_ID, min_anxiety_dt_0, min_anxiety_dt_1, min_anxiety_dt_2, min_anxiety_dt_3, min_anxiety_dt_4, min_anxiety_dt_5, min_anxiety_dt_6)
...
iph_only <-
  ...
  rename(min_anxiety_dt_0 = min_anxiety_dt_0_iph,
         min_anxiety_dt_1 = min_anxiety_dt_1_iph,
         min_anxiety_dt_2 = min_anxiety_dt_2_iph,
         min_anxiety_dt_3 = min_anxiety_dt_3_iph,
         min_anxiety_dt_4 = min_anxiety_dt_4_iph,
         min_anxiety_dt_5 = min_anxiety_dt_5_iph,
         min_anxiety_dt_6 = min_anxiety_dt_6_iph,
  )
...
all_anxiety_clean <- 
  ...
  mutate(anxiety_washout_6mos_cal = case_when(min_anxiety_dt_0 %within% interval(washout_start_dt, washout_end_dt_6mo) ~ 1,
                                              TRUE ~ 0),
         anxiety_rolling_mos1_6_cal = case_when(min_anxiety_dt_1 %within% interval(washout_start_dt + days(30), washout_end_dt_6mo + days(30)) ~ 1,
                                                TRUE ~ 0),
         anxiety_rolling_mos2_7_cal = case_when(min_anxiety_dt_2 %within% interval(washout_start_dt + days(60), washout_end_dt_6mo + days(60)) ~ 1,
                                                TRUE ~ 0),
         anxiety_rolling_mos3_8_cal = case_when(min_anxiety_dt_3 %within% interval(washout_start_dt + days(90), washout_end_dt_6mo + days(91)) ~ 1,
                                                TRUE ~ 0),
         anxiety_rolling_mos4_9_cal = case_when(min_anxiety_dt_4 %within% interval(washout_start_dt + days(121), washout_end_dt_6mo + days(121)) ~ 1,
                                                TRUE ~ 0),
         anxiety_rolling_mos5_10_cal = case_when(min_anxiety_dt_5 %within% interval(washout_start_dt + days(151), washout_end_dt_6mo + days(151)) ~ 1,
                                                 TRUE ~ 0),
         anxiety_rolling_mos6_11_cal = case_when(min_anxiety_dt_6 %within% interval(washout_start_dt + days(181), washout_end_dt_6mo + days(182)) ~ 1,
                                                 TRUE ~ 0)) |>
  select(BENE_ID, min_anxiety_dt_0, min_anxiety_dt_1, min_anxiety_dt_2, min_anxiety_dt_3, min_anxiety_dt_4, min_anxiety_dt_5, min_anxiety_dt_6, 
         anxiety_washout_6mos_cal,
