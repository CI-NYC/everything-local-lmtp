...
cohort <- load_data("msk_cohort_7_day_gap.fst")
...
ED_visits <- readRDS(file.path("/mnt/general-data/disability/everything-local-lmtp", "confounder_num_ED_visit_7_day_gap.rds"))
...
write_data(cohort_MH_joined, "msk_cohort_with_MH_7_day_gap.fst")
